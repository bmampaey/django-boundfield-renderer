...
renderer_registry.register(forms.DateField, renderer=get_template('bootstrap4/fields/date_field.html').render, context_modifier = update_context(input_type='date', min=get_min, max=get_max, value=to_iso))
renderer_registry.register(forms.DateTimeField, renderer=get_template('bootstrap4/fields/date_time_field.html').render, context_modifier = update_context(input_type='datetime-local', min=get_min, max=get_max, value=to_iso))
...
renderer_registry.register(forms.MultipleChoiceField, renderer=get_template('bootstrap4/fields/multiple_choice_field.html').render, context_modifier = update_context(options=get_options, optgroups=get_optgroups, multiple=True))
renderer_registry.register(forms.TypedMultipleChoiceField, renderer=get_template('bootstrap4/fields/typed_multiple_choice_field.html').render, context_modifier = update_context(options=get_options, optgroups=get_optgroups, multiple=True))
...
renderer_registry.register(forms.TimeField, renderer=get_template('bootstrap4/fields/time_field.html').render, context_modifier = update_context(input_type='time', min=get_min, max=get_max, value=to_iso))
...
renderer_registry.register(forms.ModelMultipleChoiceField, renderer=get_template('bootstrap4/fields/model_multiple_choice_field.html').render, context_modifier = update_context(options=get_options, multiple=True))
